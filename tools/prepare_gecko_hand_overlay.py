"""Prepare the gecko assistant hand overlay — remove exterior white background."""
...
DEFAULT_SRC = Path.home() / "Downloads" / "grok-2d4a3bdc-8de4-46c4-8918-d8c9934cd8b6.jpg"
OUT = ROOT / "assets/cards/trinkets/gecko_hand_overlay.png"
